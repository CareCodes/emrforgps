...
Begin VB.Form frmObsHistoryOrder 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Obstetric History Order"
   ClientHeight    =   6600
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   4875
   ...
   End
End
Attribute VB_Name = "frmObsHistoryOrder"
...
Private Sub btnDown_Click()
    ...
    With rsTem
        ...
        If .RecordCount > 0 Then
            ...
            .Update
        End If
        temSql = "Select * from tblSystemFinding where  Deleted = False AND IsObsHistory = True  AND SystemFindingID <> " & lstPage.BoundText & " AND orderNo <= " & ChangedNo + 1
        If .State = 1 Then .Close
        .Open temSql, cnnStores, adOpenStatic, adLockOptimistic
        While .EOF = False
            !OrderNo = !OrderNo - 1
...
Private Sub btnUp_Click()
    ...
    With rsTem
        ...
        If .RecordCount > 0 Then
            ...
            .Update
        End If
        temSql = "Select * from tblSystemFinding where Deleted = False AND IsObsHistory = True AND SystemFIndingID <> " & Val(lstPage.BoundText) & " AND orderNo >= " & ChangedNo - 1
        If .State = 1 Then .Close
        .Open temSql, cnnStores, adOpenStatic, adLockOptimistic
        While .EOF = False
            !OrderNo = !OrderNo + 1
...
Private Sub FillList()
    ...
    With rsSys
        If .State = 1 Then .Close
        temSql = "Select * from tblSystemFinding Where Deleted = False AND IsObsHistory = True"
