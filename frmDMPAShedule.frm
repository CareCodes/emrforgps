...
Begin VB.Form frmDMPAShedule 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "DMPA Shedule"
   ClientHeight    =   4830
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   6180
   ...
   Begin btButtonEx.ButtonEx btnClose 
      ...
      EndProperty
   End
   Begin MSComCtl2.DTPicker dtpDMPA1 
      Height          =   375
      Left            =   3000
      TabIndex        =   0
      Top             =   120
      ...
      CurrentDate     =   39897
   End
   Begin MSComCtl2.DTPicker dtpDMPA2 
      Height          =   375
      Left            =   3000
      TabIndex        =   2
      Top             =   600
   ...
   End
End
Attribute VB_Name = "frmDMPAShedule"
...
Private Sub dtpDMPA1_Change()
    dtpDMPA2.Value = dtpDMPA1.Value + (7 * 12)
End Sub
...
Private Sub btnPrint_Click()
    ...
    Call frmNewVisit.SaveVisitDetails
    ...
    With rstemReportItems
        ...
        temSql = "Select * from tblPrintItem  where Deleted = false AND PrintItemCategoryID = 10"
        ...
        While .EOF = False
            ...
            ElseIf !IsText = True Then
                Select Case !ItemText
                    ...
                    Case "DMPA Shedule":
                            temText = "This Dose : " & Format(dtpDMPA1.Value, LongDateFormat) & vbNewLine
                            temText = temText & "Next Date : " & Format(dtpDMPA2.Value, LongDateFormat) & vbNewLine
                    Case Else
                        temText = ""
                End Select
