...
Begin VB.MDIForm MDIMain 
   ...
   ClientTop       =   855
   ClientWidth     =   10290
   Icon            =   "MDIMainAdministrator.frx":0000
   LinkTopic       =   "MDIForm1"
   Picture         =   "MDIMainAdministrator.frx":058A
   ...
   Begin ComctlLib.ImageList ImageList2 
      ...
      BeginProperty Images {0713E8C2-850A-101B-AFC0-4210102A8DA7} 
         ...
         BeginProperty ListImage1 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "MDIMainAdministrator.frx":25B97
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "MDIMainAdministrator.frx":25EB1
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "MDIMainAdministrator.frx":261CB
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "MDIMainAdministrator.frx":264E5
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin ComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {0713E8C2-850A-101B-AFC0-4210102A8DA7} 
         NumListImages   =   4
         BeginProperty ListImage1 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "MDIMainAdministrator.frx":26F7F
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "MDIMainAdministrator.frx":83691
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "MDIMainAdministrator.frx":DFDA3
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "MDIMainAdministrator.frx":13C4B5
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin VB.Menu mnuEdit 
      ...
      Begin VB.Menu mnuEditInstitutions 
         ...
         Begin VB.Menu mnuEditHealthSchemeProviders 
            Caption         =   "Health Scheme Providers"
         End
...
'            If MyfrmNewVisit.Name = frmNewVisit.Name Then
...
Private Sub Toolbar1_ButtonClick(ByVal Button As ComctlLib.Button)
    Select Case Button.Index
        Case 1: mnuClinicalPatients_Click
        Case 2: mnuClinicalTodaysQueue_Click
        Case 3: mnuClinicalPatientDetails_Click
        Case 4: mnuPharmacyTodaysQueue_Click
    End Select
End Sub
