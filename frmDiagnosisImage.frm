...
Begin VB.Form frmDiagnosisImage 
   ...
   Begin VB.PictureBox pctImage 
      ...
      ScaleWidth      =   4275
      TabIndex        =   0
      ToolTipText     =   "Double-Click to Maximize or Restore"
      Top             =   120
      Width           =   4335
   End
End
Attribute VB_Name = "frmDiagnosisImage"
...
Private Sub Form_Load()
    ...
    Me.WindowState = 0
    Me.Height = Me.Width * (frmDiseaseInformation.imgDx.Picture.Width / frmDiseaseInformation.imgDx.Picture.Height)
    pctImage.Top = 0
    pctImage.Left = 0
    ...
    pctImage.PaintPicture frmDiseaseInformation.imgDx.Picture, 0, 0, Me.Width, Me.Height
