...
Begin VB.Form frmItemBatchStockExpired 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Expired Batch Stock"
   ClientHeight    =   9090
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   12285
   ...
   End
End
Attribute VB_Name = "frmItemBatchStockExpired"
...
Private Sub FillGrid()
    ...
    With rsBatchStock
        ...
        temWhere = temWhere & " AND tblItemBatch.DOE < #" & Format(Date, "dd MMMM yyyy") & "# "
...
Private Sub bttnPrint_Click()
    ...
    temTopic = InstitutionName & " - Expired Item Stock"
