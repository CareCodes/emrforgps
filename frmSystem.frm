...
Private Sub btnAdd_Click()
    ...
    If IsNumeric(cmbSystem.BoundText) = False Then
        temText = cmbSystem.Text
    Else
        temText = Empty
    End If
    cmbSystem.Text = Empty
    Call EditMode
    txtSystem.Text = temText
    txtSystem.SetFocus
...
Private Sub btnDelete_Click()
    Dim i As Integer
    i = MsgBox("Are you sure you want to delete " & cmbSystem.Text, vbYesNo)
    If i = vbNo Then Exit Sub
    Dim rsTem As New ADODB.Recordset
    With rsTem
        If .State = 1 Then .Close
        temSql = "Select * from tblSystem where SystemID = " & Val(cmbSystem.BoundText)
...
Private Sub btnEdit_Click()
    If IsNumeric(cmbSystem.BoundText) = False Then Exit Sub
    Call EditMode
    txtSystem.SetFocus
    On Error Resume Next: SendKeys "{home}+{end}"
End Sub
...
Private Sub btnSave_Click()
    If Trim(txtSystem.Text) = Empty Then
        MsgBox "You have not entered a System"
        txtSystem.SetFocus
        Exit Sub
    End If
    If IsNumeric(cmbSystem.BoundText) = True Then
        Call SaveOld
    Else
        Call SaveNew
    End If
...
Private Sub cmbSystem_Change()
    Call ClearValues
    If IsNumeric(cmbSystem.BoundText) = True Then Call DisplayDetails
End Sub
...
Private Sub FillCombos()
    ...
    It.FillAnyCombo cmbSystem, "System", True
End Sub
