...
Begin VB.Form frmItemStockBelowROL 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Item Stock Below Reorder Level"
   ClientHeight    =   9090
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   11400
   ...
   End
End
Attribute VB_Name = "frmItemStockBelowROL"
...
Private Sub FillGrid()
    ...
    With rsBatchStock
        ...
        If IsNumeric(cmbCategory.BoundText) = False Then
            temWhere = "WHERE (((tblItemBatchStock.Stock)<tblItem.ROL)) "
        Else
            temWhere = "WHERE (((tblItem.ItemCategoryID) = " & Val(cmbCategory.BoundText) & ") AND ((tblItemBatchStock.Stock)<tblItem.ROL))"
        End If
...
Private Sub bttnPrint_Click()
    ...
    temTopic = InstitutionName & " - Item Stock Below Reorder Level"
