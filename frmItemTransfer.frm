...
Begin VB.Form frmItemTransfer 
   ...
   Begin TabDlg.SSTab SSTab2 
      ...
      TabPicture(0)   =   "frmItemTransfer.frx":0000
      ...
      TabPicture(1)   =   "frmItemTransfer.frx":001C
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "txtLastSPP"
      Tab(1).Control(1)=   "txtLastPPP"
      Tab(1).Control(2)=   "lblPackUnit(5)"
      Tab(1).Control(3)=   "lblPackUnit(4)"
      Tab(1).Control(4)=   "Label51"
      Tab(1).Control(5)=   "Label57"
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frmItemTransfer.frx":0038
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "Label54"
      Tab(0).Control(1)=   "Label32"
      Tab(0).Control(2)=   "Label29"
      Tab(0).Control(3)=   "Label56"
      Tab(0).Control(4)=   "lblIssueUnit(0)"
      Tab(0).Control(5)=   "lblIssueUnit(1)"
      Tab(0).Control(6)=   "lblIssueUnit(2)"
      Tab(0).Control(7)=   "lblIssueUnit(3)"
      Tab(0).Control(8)=   "txtFQty"
      Tab(0).Control(9)=   "txtQty"
      Tab(0).Control(10)=   "txtPPrice"
      Tab(0).Control(11)=   "txtSPrice"
      Tab(0).ControlCount=   12
      TabCaption(1)   =   "By Pack Units"
      TabPicture(1)   =   "frmItemTransfer.frx":0054
