...
Begin VB.Form frmActionExpected 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Referral Actions expected"
   ClientHeight    =   4470
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   10905
   ...
   End
End
Attribute VB_Name = "frmActionExpected"
...
Private Sub FillCombos()
    ...
    Cat.FillBoolCombo cmbCategory, "Category", "Category", "IsActionExpected", True
End Sub
